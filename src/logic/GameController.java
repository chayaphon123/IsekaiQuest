...
//            try {
//                while(true){
//                    if(!isGameOver && !isWin) startPhase();
//                    else break;
//                    if(!isGameOver && !isWin) drawPhase();
//                    else break;
//                    actionPhase();
//                    if(!isGameOver && !isWin) enemyTurn();
//                    else break;
//                }
//                if(isWin){
//                    // win page
...
//                }
//                else {
//                    throw new RuntimeException("this should not happended");
//                }
...
//        thread.start();
                ...
                if(playerTeam.getMembers().isEmpty()) {
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // create new 'next' button and add to scene
                            //NextButton next = new NextButton(Phase.draw);
                            //battleSceneController.addNextButton(next);
                        }
                    });
                    Thread.sleep(500);
                    drawPhase();
    ...
    public void drawPhase(){
     ...
     public ArrayList<Card> getAllCards() {
         ...
         cards.addAll(getBattleBoard().getController().getBatTeam1().getController().getBattleLine1().getController().getCards());
         cards.addAll(getBattleBoard().getController().getBatTeam1().getController().getBattleLine2().getController().getCards());
         cards.addAll(getBattleBoard().getController().getBatTeam1().getController().getBattleLine3().getController().getCards());
         cards.addAll(getBattleBoard().getController().getBatTeam2().getController().getBattleLine1().getController().getCards());
         cards.addAll(getBattleBoard().getController().getBatTeam2().getController().getBattleLine2().getController().getCards());
         cards.addAll(getBattleBoard().getController().getBatTeam2().getController().getBattleLine3().getController().getCards());
         return cards;
     }

//     public void updateCardsHp() {
//         Platform.runLater(new Runnable() {
//             @Override
//             public void run() {
//                 getAllCards().forEach(card -> {
//                     card.getController().updateCharacterHp();
//                 });
//             }
//         });
//     }

//     public void updateAliveCharacter() {
//        Thread thread = new Thread(()->{
//            try {
//                Thread.sleep(500);
//            } catch (InterruptedException e) {
...
//            getAllCards().forEach(card -> {
//                if(!card.getController().getCharacter().isAlive()) deadCards.add(card);
//            });
//            deadCards.forEach(card -> {
//                System.out.println("dead card!");
//                System.out.println(card.getController().getCharacter().getName() + " down");
//            });
//            Platform.runLater(new Runnable() {
//                @Override
//                public void run() {
...
//                        playerTeam.removeCharacter(card.getController().getCharacter());
//                        enemyTeam.removeCharacter(card.getController().getCharacter());
//                    });
//
//                    if(!deadCards.isEmpty()){
//                        getBattleBoard().getController().getBatTeam1().getController().setTeam(
//                                GameController.getInstance().getPlayerTeam()
//                        );
//                        getBattleBoard().getController().getBatTeam2().getController().setTeam(
//                                GameController.getInstance().getEnemyTeam()
//                        );
//                        if(getPlayerTeam().getMembers().isEmpty()) {
//                            gameOver();
//                        }
//                        else if(getEnemyTeam().getMembers().isEmpty()) {
//                            gameWin();
//                        }
//                    }
//                    setCharactersColorToNormal();
//                }
//            });
//        });
//        thread.start();
...
//    }
    ...
    public boolean runEffectByEvent(TriggerEvent triggerEvent, BaseCharacter character) {
        ...
        return hasAny;
//        boolean hasAny = false;
//        if(triggerEvent == TriggerEvent.RECEIVE_DEBUFF) {
//            for(int i=0; i<character.getStatusEffect().size(); i++) {
//                Effect effect = character.getStatusEffect().get(i);
//                if(effect.getTriggerEvent() == TriggerEvent.RECEIVE_DEBUFF) {
//                    effect.activate();
//                    hasAny = true;
//                }
//            }
//        } else if (triggerEvent == TriggerEvent.HP_LTE_0) {
//            for(int i=0; i<character.getStatusEffect().size(); i++) {
//                Effect effect = character.getStatusEffect().get(i);
//                if(effect.getTriggerEvent() == TriggerEvent.HP_LTE_0) {
//                    effect.activate();
//                    hasAny = true;
//                }
//            }
//        } else if (triggerEvent == TriggerEvent.DEAL_DAMAGE) {
//
//        }
    }
